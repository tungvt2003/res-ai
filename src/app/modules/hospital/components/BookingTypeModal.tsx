...
const BookingTypeModal: React.FC<BookingTypeModalProps> = ({ isOpen, onClose, onSelect }) => {
  ...
  return (
    <Modal open={isOpen} closable={false} footer={null} centered width={500} className="rounded-2xl">
        ...
        <div className="grid grid-cols-2 gap-5 w-full">
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-500 mt-1">Dành cho bệnh nhân khám lần đầu hoặc chưa có hồ sơ.</p>
            </div>
          </div>
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-500 mt-1">Dành cho bệnh nhân đã có hồ sơ khám trước đó.</p>
            </div>
          </div>
        </div>
      </div>
