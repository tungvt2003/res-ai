...
import { Button, GetProps, Input, Radio, RadioChangeEvent, Select, Skeleton, Tabs, TabsProps } from "antd"
...
const NhaThuocPage = () => {
  ...
  const { data: hospitalsByCityAndWard } = useGetHospitalsbyWardAndCityQuery(selectedCity, selectedWard, {
  ...
  const hospitalDetail = filteredHospitals.find(h => h.hospital_id === selectedHospital) || filteredHospitals[0]
              ...
              {hospitalDetail ? (
                <>
                  ...
                  <div className="flex gap-5">
                    ...
                    <div className="flex flex-col gap-2">
                      <p>
                        <span className="font-semibold">Địa chỉ:</span> {hospitalDetail.address}, {hospitalDetail.ward},{" "}
                        {hospitalDetail.city}
                      </p>
                      <p>
                        <span className="font-semibold">Điện thoại:</span>{" "}
                        <a href={`tel:${hospitalDetail.phone}`} className="text-blue-600 hover:underline">
                          {hospitalDetail.phone}
                        </a>
                      </p>
                      <p>
                        <span className="font-semibold">Email:</span>{" "}
                        <a href={`mailto:${hospitalDetail.email}`} className="text-blue-600 hover:underline">
