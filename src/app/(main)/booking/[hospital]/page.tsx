...
import { Avatar, Button, Card, Col, Input, List, Radio, Row, Select, Space, Spin, Tag, Typography } from "antd"
            ...
            <Card title="Bộ lọc bác sĩ">
              <Space direction="vertical" style={{ width: "100%" }}>
                ...
                <div>
                  ...
                  <Radio.Group onChange={e => setGenderFilter(e.target.value)} value={genderFilter}>
