...
import { FaCheckCircle, FaBox, FaTruck, FaHome, FaCalendarCheck, FaPills, FaTimesCircle } from "react-icons/fa"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="bg-gradient-to-r from-red-400 to-red-500 px-8 py-12 text-center">
              ...
              <p className="mt-3 text-lg text-white/90">Đơn hàng của bạn chưa được thanh toán. Vui lòng thử lại.</p>
            </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="bg-gradient-to-r from-blue-400 to-blue-500 px-8 py-12 text-center">
            ...
            <p className="mt-3 text-lg text-white/90">Cảm ơn bạn đã tin tưởng sử dụng dịch vụ của chúng tôi</p>
          </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-blue-50 rounded-xl p-6 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex justify-between items-center bg-white rounded-lg p-3">
                  ...
                  {orderType === "booking" ? (
                    <span className="text-gray-900 font-bold">#{Date.now().toString().slice(-8)}</span>
                  ) : (
                    <span className="text-gray-900 font-bold">#{localStorage.getItem("orderId")}</span>
                  )}
                </div>
                <div className="flex justify-between items-center bg-white rounded-lg p-3">
                  <span className="text-gray-600 font-medium">Ngày đặt:</span>
                  <span className="text-gray-900 font-bold">{dayjs().format("DD/MM/YYYY HH:mm")}</span>
                </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 mb-8">
                          ...
                          <div className="flex items-center gap-2">
                            {item.sale_price && item.sale_price < item.price ? (
                              <>
                                ...
                                <span className="text-red-500 font-semibold">{item.sale_price.toLocaleString()}₫</span>
                              </>
                            ) : (
                ...
                <div className="mt-4 pt-4 border-t border-gray-200">
                  <div className="flex justify-between items-center">
                    <span className="text-lg font-semibold text-gray-700">Tổng giá trị đơn hàng:</span>
                    <span className="text-2xl font-bold text-blue-600">{orderTotal.toLocaleString()}₫</span>
                  </div>
                </div>
              </div>
            )}
                  ...
                  <>
                    ...
                    <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg border-l-4 border-gray-300">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">Bạn sẽ nhận email/SMS khi lịch hẹn được xác nhận</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg border-l-4 border-gray-300">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">Đến bệnh viện đúng giờ hẹn để được khám</p>
                      </div>
                    </div>
                  </>
                ) : (
                  <>
                    <div className="flex items-start gap-4 p-4 bg-blue-50 rounded-lg border-l-4 border-blue-500">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">Đơn hàng của bạn đã được tiếp nhận và đang xử lý</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg border-l-4 border-gray-300">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">Nhà thuốc sẽ chuẩn bị đơn hàng trong 1-2 giờ</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg border-l-4 border-gray-300">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">Đơn hàng sẽ được giao trong 1-3 ngày làm việc</p>
                      </div>
                    </div>
                  </>
                )}
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-600">
            Cần hỗ trợ?{" "}
            <a href="mailto:support@deepeyex.com" className="text-blue-600 hover:underline font-semibold">
