...
const Consultation = () => {
  ...
  useEffect(() => {
    ...
    const q = query(collection(db, "conversations"), where("participants", "array-contains", patient_id))
                ...
                <div className="flex flex-col gap-5">
                  ...
                  {(() => {
                    ...
                    if (isError || !data?.data?.length) {
                      return <div className="text-center text-gray-400 mt-6">Không có lịch tư vấn trực tuyến nào.</div>
                    }
                ...
                <div className="flex h-[30vh] md:h-[75vh] xl:h-[60vh]">
                  ...
                  <div className="w-1/4 border-r bg-white flex flex-col">
                    ...
                    {loading ? (
                      ...
                      <div className="text-center text-gray-400 mt-10">Không có cuộc hội thoại nào.</div>
                    )}
                  </div>
                          ...
                          <div className="w-1/3 bg-white p-4 flex flex-col border-l shadow-inner">
                            ...
                            <div className="flex items-center gap-3 mb-4">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-gray-500">{selectedChat.participants.join(", ")}</p>
                              </div>
                            </div>
