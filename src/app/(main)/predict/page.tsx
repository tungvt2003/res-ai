        ...
        <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-4xl flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 flex flex-col">
            <div className="bg-gray-50 p-6 rounded-md shadow-inner flex-grow flex flex-col items-center justify-center text-center">
              {!file && <p className="text-gray-500 text-lg">Tải lên một bức ảnh để bắt đầu chẩn đoán.</p>}
                ...
                <div className="flex justify-center items-end gap-6 mt-6">
                  {topDiagnoses.map((d, idx) => (
                    ...
                    >
                      {/* Vòng tròn */}
                      <div
                        className={`relative flex items-center justify-center ${idx === 0 ? "w-28 h-28" : "w-24 h-24"}`}
                      >
                        ...
                        <span className="text-lg font-bold text-cyan-600">{(d.probability * 100).toFixed(0)}%</span>
                      </div>
                      ...
                      {/* Thứ hạng */}
                      <p className={`mt-1 font-semibold ${idx === 0 ? "text-yellow-600" : "text-gray-500"}`}>
                        #{idx + 1}
                      </p>
                    </div>
                  ))}
