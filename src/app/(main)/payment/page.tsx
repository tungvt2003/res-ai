...
const OrderPage = () => {
  ...
  const [pendingEmailData, setPendingEmailData] = useState<SendOrderConfirmationRequest | null>(null)
  ...
  const handleCompleteOrderDrug = () => {
    ...
    const emailData: SendOrderConfirmationRequest = {
      ...
      delivery_method: shippingMethod === "delivery" ? ("HOME_DELIVERY" as const) : ("PICKUP" as const),
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="flex justify-between items-center mb-4">
              <button className="flex items-center text-gray-600 hover:text-blue-500" onClick={() => router.back()}>
                        ...
                        {type === "thuoc" && (
                          <>
                            {item.sale_price ? (
                              ...
                              <span className="text-blue-500 font-bold">{item.price.toLocaleString()}₫</span>
                            )}
                          </>
                        )}
                        {type === "booking" && (
              ...
              <div className="flex space-x-2 mb-6">
                <button
                  className={`py-2 px-4 rounded-full font-medium ${
                    shippingMethod === "delivery" ? "bg-blue-500 text-white" : "bg-gray-200 text-gray-700"
                  }`}
                ...
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <input
                      ...
                      onChange={e => setDeliveryInfo({ ...deliveryInfo, receiverEmail: e.target.value })}
                      className="p-3 border border-gray-600 rounded-md"
                    />
                    <select
                ...
                >
                  <div
                    className={`w-5 h-5 rounded-full border flex items-center justify-center ${
                      paymentMethod === method.key ? "border-blue-500 bg-blue-500" : "border-gray-400"
                    }`}
                  >
                    {paymentMethod === method.key && <div className="w-2 h-2 rounded-full bg-white"></div>}
                  </div>
                  <div>
